...
ggsave("Figures/figure3_core.png",
...
ggsave("Figures/figure3_SDC.png",
       width = 2.7, height = 2.5, units = "in", dpi = 320)
...
ggsave("Figures/figure3_SDC_FHSprop.png",
...
ggsave("Figures/figure3_DTS.png",
...
ggsave("Figures/figure3_psi.png",
       width = 2.7, height = 2.5, units = "in", dpi = 320)
...
ggsave("Figures/figure3_psi_beta.png",
       width = 2.7, height = 2.5, units = "in", dpi = 320)
...
ggsave("Figures/figure3_psi_beta_HSprop.png",
       width = 3.3, height = 2.5, units = "in", dpi = 320)
...
ggsave("Figures/figure3_patch_dist.png",
       width = 3, height = 2.5, units = "in", dpi = 320)
